...
<nav class="navbar navbar-expand-lg bg-light">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">
            ...
            <img src="https://icons.iconarchive.com/icons/emey87/social-button/32/blog-icon.png" width="32" height="32"
                alt="Blog Icon"> Blog
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarColor04">
            ...
            <form class="d-flex" action="result.php" method="GET">
                <input class="form-control me-sm-2" type="search" placeholder="Search" name="search" <?php if (isset($_GET['search'])) {
