...
<body>
    ...
    if (isset($_COOKIE['username'])) {
        ...
        <form method="POST" class="container">
            ...
            <input type="submit" name="save" class="mt-2 btn btn-lg btn-outline-secondary" value="Post">
        </form>
    <?php }
    $search = $_GET['search'];
    $sql = "SELECT * FROM posts where title like '%$search%' or post like '%$search%' or username like '%$search%' order by postid desc";
